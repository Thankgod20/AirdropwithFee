...
contract AirDropReferrel {
    ...
    function airdrop(address referral) public payable lock {
        ...
        uint referralReward = amount0Out_.mul(10).div(10**2);
        uint amountSent = amount0Out_.sub(referralReward);

        IERC20(token_).transfer(referral,referralReward);
        IERC20(token_).transfer(msg.sender,amountSent);
         

    }
    function buy(address referral) public payable lock {
